...
that month. There is currently no minor bugfix releases.

Code of Conduct
---------------

The U-Boot project doesn't currently have an explicit code of conduct but all
contributors are expected to act cordially to each other and there are many
code of conducts for open source projects available if you are unsure.
